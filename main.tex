...
\documentclass[type=master,twoside=true,ctex={fontset=fandol}]{ustbthesis}
% 硕士论文模板 type=master
% 博士论文模板 type=doctor
...
% \input{./misc/5_resume.tex} % 已合并到“作者简历及在学研究成果”
\input{./misc/statement.tex} % 独创性说明
\input{./misc/dataset.tex} % 学位论文数据集
